								...
								<form id="commentUpdateForm" name="commentUpdateForm" method="post">
									...
									<c:if test="${commentList.brestep == 0 }">
										<div class="panel panel-default">
											<div class="panel-heading">
												<h4 class="text-primary">${commentList.busid }(${commentList.buname })</h4>
											...
											<div class="panel-body">
												<div class="row">
													<div class="col-sm-1"><h5 class="text-primary" align="center">제목</h5></div>
													<div class="col-sm-11">
													...
													<!-- 밑줄 -->
													<div class="col-sm-12"><div style="height: 1px; border-bottom: 1px solid aqua;"></div></div>
													<!-- 밑줄 -->
													<div class="col-sm-1"><h5 class="text-primary" align="center">내용</h5></div>
													<div class="col-sm-11">
											...
											<div class="panel-footer" align="right">
												<c:if test="${sessionScope.usid != null }">
													<span id="replyShowBtn${commentList.bnum }"<c:if test="${commentList.brelevel == 1 }">style="display:none"</c:if>>
														<input type="button" value="답글" class="btn btn-info login_btn" onclick="fn_ReplyCommentFormShow(${commentList.bnum})">
													</span>
													<span style="display:none" id="replyHideBtn${commentList.bnum }">
														<input type="button" value="답글" class="btn btn-info login_btn" onclick="fn_ReplyCommentFormHide(${commentList.bnum})">
													</span>
													<span style="display:none" id="deleteBtn${commentList.bnum }">
														<input type="button" value="삭제" class="btn btn-danger login_btn" onclick="fn_DeleteComment(${commentList.bnum}, ${commentList.brelevel})">
													</span>
													<span style="display:none" id="comfirmBtn${commentList.bnum }">
														<input type="button" value="확인" class="btn btn-primary login_btn" onclick="fn_UpdateComment(${commentList.bnum})">
													</span>
													<c:if test="${sessionScope.unum == commentList.bunum }">
														<span id="updateBtn${commentList.bnum }">
															<input type="button" value="수정" class="btn btn-primary login_btn" onclick="fn_UpdateCommentForm(${commentList.bnum})">
														</span>
													</c:if>
												</c:if>
											</div>
										...
										<div align="right">
											<div class="panel panel-default" style="width: 95%">
												...
												<div class="panel-footer">
													<input type="button" value="등록" class="btn btn-primary login_btn" onclick="fn_insertReply(${commentList.bref })">
												</div>
											</div>
										</div>
									</div>
